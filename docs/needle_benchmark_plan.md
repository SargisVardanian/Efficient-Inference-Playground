...
- The active KV-cache path now uses a Gemma4-compatible hybrid recency-window policy: native sliding layers are preserved, and full-attention layers keep a contiguous 1024-token recency window.
